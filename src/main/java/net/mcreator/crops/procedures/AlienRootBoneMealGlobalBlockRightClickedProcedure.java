...
public class AlienRootBoneMealGlobalBlockRightClickedProcedure {
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if ((((entity instanceof LivingEntity) ? ((LivingEntity) entity).getHeldItemMainhand() : ItemStack.EMPTY).getItem() == (itemBoneMeal)
			...
			if ((((world.getBlockState(new BlockPos((int) x, (int) y, (int) z))).getBlock() == (blockStage0).getBlock()) || (((world
					.getBlockState(new BlockPos((int) x, (int) y, (int) z))).getBlock() == (blockStage1).getBlock())
					|| (((world.getBlockState(new BlockPos((int) x, (int) y, (int) z))).getBlock() == (blockStage2).getBlock()) || (((world
							.getBlockState(new BlockPos((int) x, (int) y, (int) z))).getBlock() == (blockStage3).getBlock())
							|| (((world.getBlockState(new BlockPos((int) x, (int) y, (int) z))).getBlock() == (blockStage4).getBlock())
									|| (((world.getBlockState(new BlockPos((int) x, (int) y, (int) z))).getBlock() == (blockStage5).getBlock())
											|| ((world.getBlockState(new BlockPos((int) x, (int) y, (int) z))).getBlock() == (blockStage6)
													.getBlock())))))))) {
				if (!world.isRemote()) {
					BlockPos _bp = new BlockPos((int) x, (int) y, (int) z);
